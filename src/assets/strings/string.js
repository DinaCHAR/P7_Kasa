const APPLICATION_CONSTANTS = {
    HOME_TITLE : 'Chez vous, partout et ailleurs',
    DEFAULT_ERROR_NUMBER: '404',
    DEFAULT_ERROR_MESSAGE: 'Oups! La page que vous demandez n\'existe pas.',
    BACK_TO_HOME: "Retourner sur la page d’accueil",
    LEGALS_MENTION: "© "+ new Date().getFullYear() +" Kasa. All rights reserved",
    ABOUT_INFORMATIONS : [
        {
